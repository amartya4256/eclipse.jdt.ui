...
public final class RefactoringExecutionStarter {
	...
	public static void startSelfEncapsulateRefactoring(final List<IField> fields, List<IField> preselected, final Shell shell) {
		...
		new RefactoringStarter().activate(new SelfEncapsulateFieldWizard(new SelfEncapsulateFieldCompositeRefactoring(getRefactoringFromFields(fields)), preselected), shell, "", IRefactoringSaveModes.SAVE_REFACTORING); //$NON-NLS-1$
	}
